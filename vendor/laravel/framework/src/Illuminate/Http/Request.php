...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    public function session()
    {
        ...
        if ($this->session instanceof SymfonySessionDecorator && property_exists($this->session, 'store')) {
            return $this->session->store;
        }

        // If the session is not a SymfonySessionDecorator, just return it (for custom session drivers)
        return $this->session;
    }
